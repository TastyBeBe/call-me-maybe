...
/**
 * Inline SVG ikony (lucide-style, stroke currentColor, viewBox 0 0 24 24).
 * Žádné externí závislosti — cesty jsou psané přímo tady.
 */

export type IconProps = SVGProps<SVGSVGElement> & { size?: number };

function Icon({ size = 24, children, style, ...rest }: IconProps & { children: ReactNode }) {
  return (
    <svg
